    ...
    return (
        <>
            ...
            <div className='col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 '>
                        <h1 className='head-heading'>Fit learning into your life with <text className="strong">Blinkist</text></h1>
...
<div className="infobar">
    <div className="infoleft"><p>You can try Blinkist for <strong>free.</strong> Don’t worry, if you don't have Blinkist account make one.</p></div>
